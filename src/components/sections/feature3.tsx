...
const FEATURES = [
  {
    ...
    content: {
      ...
      description: `Simple, robust, and blazingly fast. streamline is designed with developer ergonomics in mind. It's the first issue tracker your team will actually enjoy using.`,
