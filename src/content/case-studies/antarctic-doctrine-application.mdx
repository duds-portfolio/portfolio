...
<Alert 
  ...
  message="78% improvement in safety protocol adherence, 100% availability during 6-month Antarctic winter isolation, policy reference time reduced from minutes to seconds, framework deployed across all Australian Antarctic stations" 
/>
