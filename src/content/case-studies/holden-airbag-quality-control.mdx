...
<Alert 
  ...
  message="100% safety compliance rate achieved, 95% improvement in defect detection accuracy, 30% reduction in quality control time, prototype adopted by tool manufacturers worldwide as global standard" 
/>
