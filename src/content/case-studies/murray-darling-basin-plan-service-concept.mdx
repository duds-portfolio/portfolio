...
<Alert 
  ...
  message="Multi-jurisdictional coordination framework across 5 states, 23 different stakeholder types mapped and engaged, 15 key service interactions blueprinted, comprehensive end-to-end service delivery model" 
/>
